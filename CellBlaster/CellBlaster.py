...
class CellBlaster():
    def __init__(self,dabase_type,symbols,output_path,query,query_symbol,filter_keywords): 
    ...
    def Annotation(self,output_path,symbols,dabase_type,query,query_symbol,filter_keywords):
...
if __name__ == '__main__':
    ...
    cellblaster = CellBlaster(output_path,symbols,dabase_type,query,query_symbol,filter_keywords)
    result = cellblaster.Annotation(output_path,symbols,dabase_type,query,query_symbol,filter_keywords)
